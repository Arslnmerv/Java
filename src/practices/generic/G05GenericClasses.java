...
public class G05GenericClasses {
    public static void main(String[] args) {
        veriSakla<String> veri1 = new veriSakla<>("bahar hanım neden olmasın");
        veriSakla<Integer> veri2 = new veriSakla<>(100000);
        veriSakla<Double> veri3 = new veriSakla<>(3.14);
// veriSakla Class'tan create edilen obj get() met. calıstık
        System.out.println(veri1.getVeri());
        System.out.println(veri2.getVeri());
        System.out.println(veri3.getVeri());

// veriSakla Class'tan create edilen obj veriYazdir Class'daki yazdir() met call  calıstık
